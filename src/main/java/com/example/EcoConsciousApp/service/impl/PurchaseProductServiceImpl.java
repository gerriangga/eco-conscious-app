...
import com.example.EcoConsciousApp.specification.TransactionSpecification;
...
public class PurchaseProductServiceImpl implements PurchaseProductService {
    ...
    @Override
    public List<PurchaseProduct> getAllTransaction(TransactionSearchDTO transactionSearchDTO) {
        Specification<PurchaseProduct> purchaseSpecification = TransactionSpecification.getSpesification(transactionSearchDTO);
        return purchaseProductRepository.findAll(purchaseSpecification);
    }
