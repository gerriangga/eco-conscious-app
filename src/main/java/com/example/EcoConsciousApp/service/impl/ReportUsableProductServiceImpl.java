...
public class ReportUsableProductServiceImpl implements ReportUsableProductService {
    ...
    public String exportReport(String reportFormat) throws FileNotFoundException, JRException {
        ...
        if (reportFormat.equalsIgnoreCase("html")) {
            JasperExportManager.exportReportToHtmlFile(jasperPrint, ResponseMessage.PATH + "\\usable-products.html");
        }

        if (reportFormat.equalsIgnoreCase("pdf")) {
            JasperExportManager.exportReportToPdfFile(jasperPrint, ResponseMessage.PATH + "\\usable-products.pdf");
        }
        return "report generated in path : " + ResponseMessage.PATH;
    }
}
